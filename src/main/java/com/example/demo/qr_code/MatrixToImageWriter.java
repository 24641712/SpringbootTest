...
public class MatrixToImageWriter {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
       String redict = "https://blog.csdn.net/zhangleiyes123/article/details/82857195";
        // 依次为内容(不支持中文),宽,长,中间图标路径,储存路径
        String url = " https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx841a97238d9e17b2&redirect_uri=http://cps.dianping.com/weiXinRedirect&response_type=code&scope=snsapi_base&state=type%3Dquan%2Curl%3Dhttp%3A%2F%2Fmm.dianping.com%2Fweixin%2Faccount%2Fhome";
        MatrixToImageWriter.encode(url, 512, 512,
                "G:\\QRcode\\touxiang.jpg", "G:\\QRcode\\QRcode.jpg");
    }
